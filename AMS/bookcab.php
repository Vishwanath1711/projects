...
<html lang="en">
  <head>
    ...
    <style>
    body{
      background-image:url('/apartment/Images/apartment10.jpg');
      height:100vh;
    ...
    input[type=submit]
{
  ...
  <div class="wrap">
      ...
      ?>
      <form action="bookcab1.php?flatno=<?php echo $row['Flat_No'];?>"method="POST">
          <?php
          }
          }
          ?>
  <div class="form-row">
    ...
    <font color="white"><label for="validationServer01">Flat Number</label></font>
     ...
     <font color="white"> <label for="validationServer05">Time</label></font>
      <input type="time" class="form-control" id="validationServer05" placeholder="Time" name="time" required>
      ...
      <font color="white"> <label for="validationServer05">Cab Type</label></font>
      <input type="text" class="form-control" id="validationServer05" placeholder="Cab Type" name="cabtype" required>
      <br>
      <br>
